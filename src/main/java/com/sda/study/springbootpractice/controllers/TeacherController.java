...
public class TeacherController {
    ...
    public ResponseEntity<?> createTeacher(@RequestBody Teacher teacher) {
        ...
        try{
            ...
            throw new RuntimeException("Teacher already exists! Cannot create the teacher");
    ...
    @PostMapping("/update")
    public ResponseEntity<?> updateSchool(@RequestBody Teacher teacher) throws TeacherNotFoundException {
